...
export default class Main extends Component {
  ...
  forceUpdateDebouce = () => {
    console.log("window.setting.ajaxInterceptor_rules",window.setting.ajaxInterceptor_rules);
  ...
  handleFilterCodeChange = (val, i) => {
    window.setting.ajaxInterceptor_rules[i].filterCode = val;
    this.set('ajaxInterceptor_rules', window.setting.ajaxInterceptor_rules);
  ...
  zeroAddBtn=()=>{
    if(window.setting.ajaxInterceptor_rules.length==0){
      this.handleClickAdd();
    }
  }
                    ...
                    header={
                      <div className="panel-header" onClick={e => e.stopPropagation()}>
                        <Input.Group compact style={{width: '85%'}}>
                          <Select defaultValue="200" style={{width: '15%'}} onChange={e => this.handleFilterCodeChange(e, i)}>
                            <Option value="200">200 OK</Option>
                            <Option value="400">400 Not Found</Option>
                            <Option value="500">500 Internal Server Error</Option>
                          </Select>
                          <Select defaultValue={filterType} style={{width: '15%'}} onChange={e => this.handleFilterTypeChange(e, i)}>
